// Shared package: @ccwg/shared/types/contracts
...
export const ESCROW_SYSTEM_ADDRESS = process.env.NEXT_PUBLIC_ESCROW_SYSTEM_ADDRESS as `0x${string}` || process.env.ESCROW_SYSTEM_ADDRESS as `0x${string}` || '0x038b42fdfb42a25de102d628e271b57e24594e48eb4e9ddfa3c0d25aeb3f7b9a';
export const EVENT_SYSTEM_ADDRESS = process.env.NEXT_PUBLIC_EVENT_SYSTEM_ADDRESS as `0x${string}` || process.env.EVENT_SYSTEM_ADDRESS as `0x${string}` || '0x05b238e4ca47e7e61cd5738a1011da8ea45854d176d08c9ba185fc0be38373f5';
export const ORACLE_SYSTEM_ADDRESS = process.env.NEXT_PUBLIC_ORACLE_SYSTEM_ADDRESS as `0x${string}` || process.env.ORACLE_SYSTEM_ADDRESS as `0x${string}` || '0x048e4128aeafe0a088d2525e2e2ff8e4123ab82dc2b8962c7b296fde30a07990';
