...
export interface MomentumData {
  ...
  momentum_percent: number; // Percentage as basis points (e.g., 250 = 2.5%)
}
...
export interface AIConfig {
  ...
  reaction_delay_ms: number; // Simulated thinking time
  strategy_complexity: number; // 1-10
  card_quality_boost: number; // Stat multiplier
}

// Stake tier values (in wei, 18 decimals)
export const STAKE_TIER_VALUES: Record<StakeTier, string> = {
  Tier10: '10000000000000000000', // 10 STRK
  Tier20: '20000000000000000000', // 20 STRK
  Tier100: '100000000000000000000', // 100 STRK
};
